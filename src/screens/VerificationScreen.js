          ...
          >
            <Animated.View style={[
              ...
              <Image 
                ...
                resizeMode="cover"
              />
              <Text style={[styles.title, { color: theme.primary }]}>{getText('verification', 'title')}</Text>
            </Animated.View>
            ...
            <Animated.Text style={[
              ...
              {getText('verification', 'nationality')}: <Text style={[styles.bold, { color: theme.primary }]}>{isIndian ? 'Indian' : 'Other'}</Text>
            </Animated.Text>
            ...
            >
              {isIndian ? (
                <>
                  <Text style={[styles.label, { color: theme.primary }]}>{getText('verification', 'aadhaarId')}</Text>
                  <TextInput
                    style={[styles.input, { backgroundColor: theme.inputBg, borderColor: theme.border, color: theme.inputText }]}
                    placeholder={getText('verification', 'aadhaarPlaceholder')}
                    placeholderTextColor={theme.mode === 'dark' ? '#999999' : '#7e7e7e'}
                    value={aadhaarId}
                  ...
                  <Text style={[styles.label, { color: theme.primary }]}>{getText('verification', 'address')}</Text>
                  <TextInput
                    style={[styles.input, styles.multiline, { backgroundColor: theme.inputBg, borderColor: theme.border, color: theme.inputText }]}
                    placeholder={getText('verification', 'addressPlaceholder')}
                    placeholderTextColor={theme.mode === 'dark' ? '#999999' : '#7e7e7e'}
                    value={address}
                  ...
                  <Text style={[styles.label, { color: theme.primary }]}>{getText('verification', 'placesToVisit')}</Text>
                  <TextInput
                    style={[styles.input, styles.multiline, { backgroundColor: theme.inputBg, borderColor: theme.border, color: theme.inputText }]}
                    placeholder={getText('verification', 'placesToVisitPlaceholder')}
                    placeholderTextColor={theme.mode === 'dark' ? '#999999' : '#7e7e7e'}
                    value={placesToVisit}
                  ...
                  <Text style={[styles.label, { color: theme.primary }]}>{getText('verification', 'numberOfDays')}</Text>
                  <TextInput
                    style={[styles.input, { backgroundColor: theme.inputBg, borderColor: theme.border, color: theme.inputText }]}
                    placeholder={getText('verification', 'numberOfDaysPlaceholder')}
                    placeholderTextColor={theme.mode === 'dark' ? '#999999' : '#7e7e7e'}
                    value={numberOfDays}
                ...
                <>
                  <Text style={[styles.label, { color: theme.primary }]}>{getText('verification', 'visaId')}</Text>
                  <TextInput
                    style={[styles.input, { backgroundColor: theme.inputBg, borderColor: theme.border, color: theme.inputText }]}
                    placeholder={getText('verification', 'visaIdPlaceholder')}
                    placeholderTextColor={theme.mode === 'dark' ? '#999999' : '#7e7e7e'}
                    value={visaId}
                  ...
                  <Text style={[styles.label, { color: theme.primary }]}>{getText('verification', 'visaValidity')}</Text>
                  <TextInput
                    style={[styles.input, { backgroundColor: theme.inputBg, borderColor: theme.border, color: theme.inputText }]}
                    placeholder={getText('verification', 'visaValidityPlaceholder')}
                    placeholderTextColor={theme.mode === 'dark' ? '#999999' : '#7e7e7e'}
                    value={visaValidity}
                  ...
                  <Text style={[styles.label, { color: theme.primary }]}>{getText('verification', 'travelPlan')}</Text>
                  <TextInput
                    style={[styles.input, styles.multiline, { backgroundColor: theme.inputBg, borderColor: theme.border, color: theme.inputText }]}
                    placeholder={getText('verification', 'travelPlanPlaceholder')}
                    placeholderTextColor={theme.mode === 'dark' ? '#999999' : '#7e7e7e'}
                    value={travelPlan}
            ...
            <Animated.View style={{ opacity: fadeAnim, marginTop: 20 }}>
              ...
              >
                ...
                >
                  <Text style={styles.buttonText}>{getText('common', 'generateId')}</Text>
                </LinearGradient>
              </TouchableOpacity>
            </Animated.View>
          </ScrollView>
